...
AREA_REP_SALES_PROFIT=pd.read_csv("E:/DASHBOARD/AREA_REP_SALES_PROFIT.csv")
AREA_REP_SALES=pd.read_csv("E:/DASHBOARD/AREA_REP_SALES.csv")
AREA_REP_SALES_reindex=pd.read_csv("E:/DASHBOARD/AREA_REP_SALES_reindex.csv")
all_pharmacies_sales=pd.read_csv("E:/DASHBOARD/all_pharmacies_sales.csv")
